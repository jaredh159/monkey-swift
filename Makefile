...
tp:
	swiftc -o ./.bin/ParserTest token/Token.swift lexer/Lexer.swift ast/ast.swift parser/Parser.swift parser/Parselet.swift parser/ParserTest.swift utils/color.swift test/test.swift main.swift && ./.bin/ParserTest
